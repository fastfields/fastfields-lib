...
)
{
    ...
    {
        offset_t out_offset = index2offset(i, nall, size_grid, stride_out);
...
)
{
    ...
    if ( jf::has_atomic_add<scalar_t>::value )
    {
        ...
        for (offset_t i=start; i < end; ++i)
        {
            ...
            offset_t inp_offset  = index2offset(i, nbatch, size_grid, stride_inp);
            offset_t out_offset  = index2offset(i, nbatch, size_grid, stride_out);
            offset_t ginp_offset = index2offset(i, nall, size_grid, stride_ginp);
...
void push_backward(
    ...
    const offset_t * size_grid,     // [*batch, *spatial_spln, C] vector
    const offset_t * size_splinc,   // [*batch, *spatial_spln, C] vector
    const offset_t * stride_out,    // [*batch, *spatial_spln, C] vector
...
)
{
    ...
    for (offset_t i=start; i < end; ++i)
    {
        ...
        offset_t inp_offset = index2offset(i, nall, size_grid, stride_inp);
        offset_t ginp_offset = index2offset(i, nbatch, size_grid, stride_ginp);
...
)
{
    ...
    if ( jf::has_atomic_add<scalar_t>::value )
    {
        ...
        auto get_grid_offset = [&](offset_t i) {
            return index2offset(i, nall, size_grid, stride_grid); };
        auto get_gout_offset = [&](offset_t i) {
            return index2offset(i, nall, size_grid, stride_gout); };
        auto get_inp_offset = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_inp); };
        auto get_out_offset = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_out); };
        auto get_ginp_offset = [&](offset_t i) {
            return index2offset(i, nall, size_grid, stride_ginp); };
    ...
    else
    {
        ...
        auto get_grid_offset0 = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_grid); };
        auto get_gout_offset0 = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_gout); };
        auto get_ginp_offset0 = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_ginp); };
        auto get_inp_offset = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_inp); };
        auto get_out_offset = [&](offset_t i) {
            return index2offset(i, nbatch, size_grid, stride_out); };
