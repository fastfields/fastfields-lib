...
template <
    ...
    spline_t spline   = spline_t::Cubic,    // Spline order
    bound_t  bound    = bound_t::DCT2,      // Boundary condition
...
{
    using Kernel = Kernels<Config<ndim, spline, bound, scalar_t, offset_t>>;
