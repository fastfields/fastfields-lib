...
std::ostream& AbstractPointer_print(
    std::ostream& stream, const ff::AbstractPointer<T,S,D> & ptr)
{
...
std::ostream& AbstractSizedPointer_print(
    std::ostream& stream, const ff::AbstractSizedPointer<T,N,S,D> & ptr)
{
...
std::ostream& operator <<(std::ostream& stream,
                          const ff::AbstractSizedPointer<T,N,S,D> & ptr)
{
...
std::ostream& AbstractVector_print(
    std::ostream& stream, const ff::AbstractVector<T,N,S,D> & ptr)
{
...
template <typename T, unsigned long N, long S, typename D>
std::ostream& operator <<(std::ostream& stream,
                          const ff::AbstractVector<T,N,S,D> & ptr)
{
...
std::ostream& WeakRef_print(
    std::ostream& stream, const ff::WeakRef<T,S,D> & ptr)
{
...
std::ostream& WeakSizedRef_print(
    std::ostream& stream, const ff::WeakSizedRef<T,N,S,D> & ptr)
{
...
std::ostream& WeakVector_print(
    std::ostream& stream, const ff::WeakVector<T,N,S,D> & ptr)
{
...
std::ostream& Vector_print(
    std::ostream& stream, const ff::Vector<T,N,D> & ptr)
{
