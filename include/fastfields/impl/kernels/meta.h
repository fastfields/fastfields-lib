...
template <int I, class T, T X, T... Y> struct _TupleAt<I, Tuple<T, X, Y...>> { using Value = _TupleAt<I-1, Tuple<T, Y...>>; };
template <class T, T X, T... Y>        struct _TupleAt<0, Tuple<T, X, Y...>> { static constexpr Value = X };
